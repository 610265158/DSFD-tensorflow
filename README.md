...
## update
+ The tf2 branch is a reimplement based on tensorflow2, the codes is runable and can produce right results, but no pretrained model(not finish). You are welcome to test it.
