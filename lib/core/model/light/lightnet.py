...
class LightnetBlock(tf.keras.Model):
    def __init__(self,
                 output_size,
                 repeat=4,
                 kernel_initializer='glorot_normal'):
        super(LightnetBlock, self).__init__()
...
class Lightnet(tf.keras.Model):
    '''
     basicly it is still a shufflenet structure,
     but the shuffle op were treated more roughly,
     refer to the function concat_shuffle_split_abstract
    '''
    ...
    def __init__(self,
        ...
        self.first_conv = tf.keras.Sequential(
            ...
            [
                ...
                #                           strides=2)
                tf.keras.layers.SeparableConv2D(24,
                                               kernel_size=(3, 3),
                                               strides=2,
                                               padding='same',
                                               use_bias=False,
